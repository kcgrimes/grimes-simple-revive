...
//bug - can enemies load unit into any vehicle? If so, this would prevent that...
if ((G_Mobile_Respawn_Locked) && ((!isNil {(_vehicle getVariable "G_MRV_Logic") getVariable "G_Side"}) && ((_unit getVariable "G_Side") != ((_vehicle getVariable "G_MRV_Logic") getVariable "G_Side")))) exitWith {
